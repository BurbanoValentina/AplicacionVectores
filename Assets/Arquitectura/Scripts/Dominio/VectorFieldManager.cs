...
namespace VectorField
{
    ...
    public class VectorFieldManager : MonoBehaviour
    {
        ...
        [Tooltip("Si esta activo, intenta detectar la isla por ruta de assets (ej. Assets/Arquitectura/Gameplay/Entorno/RPG Tiny Fantasy Forest PBR).")]
        public bool useIslandAssetFolderForBounds = true;
        public string islandAssetFolderPath = "Assets/Arquitectura/Gameplay/Entorno/RPG Tiny Fantasy Forest PBR";
